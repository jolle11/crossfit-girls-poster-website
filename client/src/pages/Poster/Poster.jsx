...
const Poster = () => {
	...
	useEffect(() => {
		if (localStorage.getItem("wods")) {
			...
			axios
				.get("https://crossfit-girls-poster-website-api.vercel.app/api/wods")
				.then((response) => {
	...
	if (isLoading === true) {
		return (
			<div className="wait">
				<h2>
					Aren't the girls here yet? <br /> Wait for them to arrive. <br /> Try
					refreshing the page in a few seconds, maybe they got lost in their
					way...
				</h2>
			</div>
		);
